...
export default function ProductPage({ params }: { params: Promise<{ category: string, slug: string }> }) {
  ...
  if (!product) {
    return (
      <main className="min-h-screen bg-[#E6E6E6] pt-40 pb-24 flex items-center justify-center">
    ...
    <main className="min-h-screen bg-[#E6E6E6] pt-40 pb-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          >
            <div className="bg-[#F5F5F5] border border-transparent rounded-sm p-12 flex items-center justify-center min-h-[500px] relative overflow-hidden shadow-sm group">
