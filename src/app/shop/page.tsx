...
export default function ShopPage() {
  ...
  return (
    <>
      <Navbar />
      <main className="min-h-screen bg-[#E6E6E6] pt-40 pb-24">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
          ...
          <motion.aside 
            ...
            className={`w-full lg:w-64 flex-shrink-0 ${isMobileFilterOpen ? 'block' : 'hidden lg:block'}`}
          >
            <div className="sticky top-32 space-y-10 bg-[#E6E6E6] lg:bg-transparent pb-6 lg:pb-0 z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
              {filteredProducts.length > 0 ? filteredProducts.map((product, index) => (
                ...
                >
                  ...
                  <div className="relative h-[240px] w-full bg-[#F5F5F5] flex items-center justify-center p-8 overflow-hidden">
                    {/* Subtle Overlay */}
                    ...
                    <div className="absolute top-4 left-4 flex flex-col gap-2 z-10">
                      ...
                      {product.status !== 'In Stock' && (
                        <span className={`text-[9px] font-syncopate px-2.5 py-1 uppercase tracking-[0.2em] font-bold ${
                  ...
                  <div className="pt-5 pb-5 px-5 flex flex-col flex-1 bg-white z-10 relative border-t border-gray-100">
                    ...
                    <div className="mt-auto flex items-end justify-between">
                      <span className="font-space font-medium text-lg text-[#111] tracking-tight">{product.price}</span>
                      <Link href={`/shop/${product.category.toLowerCase().replace(/ & | /g, '-')}/${product.slug}`} className="w-8 h-8 rounded-full border border-gray-200 flex items-center justify-center text-[#111] group-hover:bg-[#111] group-hover:text-white transition-colors">
